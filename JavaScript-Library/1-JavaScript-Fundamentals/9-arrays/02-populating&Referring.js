...
// What is an array?
// An array has [] brackets
//They can hold mutilple datatypes
...
// console.log(typeof students); //typeof doesn't tell that my variable is an array -> object.
...
//array methods
// food.push("Pizza");//"push" added to the end of our array
// console.log(food);
// food.splice(1, 1, "Bananas");
// console.log(food);
// food.splice(2, 0, "Sweet Potato Pie"); //"Splice" asks for an insertion point, how many things to remove, 
...
food.forEach((food, index) => {
    console.log(`The ${food} food in our array is at the position ${index}`);
})

let movies = ['300', 'Snow White', 'The Phantom Menace', 'The Watchmen', 'The Sound of Music'];

movies.push('The Force Awakens');
movies.splice(3, 1, 'The Legue of Extraordinary Gentlemen');
